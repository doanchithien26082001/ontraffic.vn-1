            ...
            <div class="card shadow mb-3">
                <div class="card-body">
                    <div class="title-traffic shadow-sm card-body bd-style-2 mb-2 d-flex justify-content-between align-items-center">
                        <h2 class="title-section mb-0 text-dark mb-0">Tạo Traffic Direct</h2>
                    ...
                    <form action="" class="form">
                        <div class="form-group shadow-sm card-body bd-style-2 mb-1">
                            <label for="" class="form-label fw-bold">Trang web cần redirect trỏ tới (nhập chính xác url)</label>
